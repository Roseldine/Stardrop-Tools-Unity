...
namespace StardropTools.Tween
{
    public class TweenShakeRotationEuler : TweenShakeVector3
    {
        ...
        public TweenShakeRotationEuler(Transform transform, int tweenID, Vector3 intensity, float duration, float delay, bool ignoreTimeScale, AnimationCurve curve, Tween.LoopType loop, BaseEvent<Vector3> updateEvent = null)
