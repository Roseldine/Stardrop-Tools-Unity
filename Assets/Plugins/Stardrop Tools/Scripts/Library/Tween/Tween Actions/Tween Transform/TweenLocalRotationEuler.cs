...
namespace StardropTools.Tween
{
    public class TweenLocalRotationEuler : TweenVector3
    {
        ...
        public TweenLocalRotationEuler(Transform transform, int tweenID, Vector3 targetVector, float duration, float delay, bool ignoreTimeScale, AnimationCurve curve, Tween.LoopType loop, BaseEvent<Vector3> updateEvent = null)
