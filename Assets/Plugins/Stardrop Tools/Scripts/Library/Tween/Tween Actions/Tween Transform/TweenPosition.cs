...
namespace StardropTools.Tween
{
    public class TweenPosition : TweenVector3
    {
        ...
        public TweenPosition(Transform transform, int tweenID, Vector3 targetVector, float duration, float delay, bool ignoreTimeScale, AnimationCurve curve, Tween.LoopType loop, BaseEvent<Vector3> updateEvent = null)
