...
namespace StardropTools.Tween
{
    public static class Tween
    {
        ...
        // ----------------->>                       <<----------------- //
        // --------------- //     Tween Component     \\ --------------- // 
        #region Tween Components
        public static void ProcessTweenComponent(TweenComponentBase component)
        {
            if (Application.isPlaying == false)
            {
                Debug.Log("Can't Tween in edit mode");
            ...
            TweenType type = component.tweenType;
            ...
            switch (type)
            {
                ...
                case TweenType.ShakeFloat:
                    break;

                case TweenType.ShakeInteger:
                    break;

                case TweenType.ShakeVector2:
                    break;

                case TweenType.ShakeVector3:
                    break;

                case TweenType.ShakeVector4:
                    break;

                case TweenType.ShakeQuaternion:
                    break;
                ...
                case TweenType.ShakeRotationEuler:
                    break;

                case TweenType.ShakeLocalRotationEuler:
                    break;

                case TweenType.ShakeLocalScale:
                    break;
                ...
                case TweenType.AnchoredPosition:
                    break;
                    /*
                case TweenType.ShakeSize:
                    break;

                case TweenType.ShakeAnchoredPosition:
                    break;
                    */
                case TweenType.ImageColor:
                    break;

                case TweenType.ImagePixelPerUnitMultiplier:
                    break;
            }
        }
        #endregion // tween components
    }
}