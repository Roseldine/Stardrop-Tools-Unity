...
namespace StardropTools.UI
{
    ...
    public class ScrollSnap : BaseUIObject, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
    {
        ...
        [SerializeField] System.Collections.Generic.List<ScrollSnapElement> elements;
#if UNITY_EDITOR
        ...
        public override void Initialize()
        {
            ...
            SwipeToNextPriority.AddListener(() => ScrollSnapManager.Instance.MoveNext(this, direction));
        }
        ...
        System.Collections.IEnumerator MoveCR(int index, int direction)
        {
            ...
            ScrollSnapElement elementToShow = elements[index];
            ScrollSnapElement elementToHide = elements[currentIndex];
            ...
            if (elementToShow.IsActive == false)
        ...
        void SetElementPosition(ScrollSnapElement element, int direction)
        {
        ...
        void GetElements()
        {
            ...
            elements = new System.Collections.Generic.List<ScrollSnapElement>();

            for (int i = 0; i < children.Count; i++)
            {
                // get or set Scroll Snap Element component
                ScrollSnapElement element = children[i].GetComponent<ScrollSnapElement>();
                if (element == null)
                    element = (children[i].gameObject.AddComponent<ScrollSnapElement>());
                elements.Add(element);

                sizeCopy.AddToCopyList(element.RectTransform);
        ...
        protected override void OnValidate()
        {
            ...
            if (sizeCopy == null)
            {
                ...
                sizeCopy.SetTarget(RectTransform);
            }
